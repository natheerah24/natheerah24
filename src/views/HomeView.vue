...
<v-row>
        ...
        <v-list two-line subheader class="ml-n8">
         <v-list-item>
          <v-list-item-content>
            ...
            <v-list-item-title>75 cm</v-list-item-title>
          </v-list-item-content>
         </v-list-item> 
        </v-list>
      </v-col>
  ...
  <v-col cols="12" md="4">
    <v-row>
      <v-col cols="12" md="2">
        <v-card height="50px" width="10px" color="grey">
        </v-card>
      </v-col>
      <v-col cols="12" md="10">
        <v-list two-line subheader class="ml-n8">
...
<v-list-item-content pa-2>
  <v-list-item-title class="headline mb-1">
    ...
    <h6>Dr. Elika Clark (cab 61)</h6>
      ...
      <v-col cols="12" sm="12">
      <v-btn text>Your Treatment</v-btn>
      <v-icon right>
        mdi-chevron-down
      </v-icon>
      </v-col>
      <v-col cols="12" sm="12">
        ...
        color="teal lighten-5" flat>
      <v-list-item three-line>
        <v-list-avatar tile size="30">
         <v-icon size="30" color="teal">mdi-pill</v-icon> 
        </v-list-avatar>
        <v-list-item-content class="pa-2">
  <v-list-item-title class="headline mb-1">
    Gentle Iron <br>
    <h6><span class="teal--text">2 capsules </span> with meals everyday</h6>
